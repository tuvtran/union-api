...
companies = [
    {
        ...
        'founders': [
            {
                'name': 'Eric Wu',
                'email': 'eric@trygainful.com',
                'role': 'CEO'
            },
            {
                'name': 'Jahaan Ansari',
                'email': 'jahaan@trygainful.com',
                'role': 'CTO'
            },
            {
                'name': 'Jeffrey Yan',
                'email': 'jeffrey@trygainful.com',
                'role': 'VP Engineering'
            },
        ],
        'bio': """Gainful is protein powder tailored specifically
        to your body type and fitness goals.""",
        'website': 'https://trygainful.com/'
    },
    {
        'name': 'Retarget Links',
        'founders': [
            {
                'name': 'Serge Salager',
                'email': 'serge.salager@retargetlinks.com',
                'role': 'CEO'
            },
        ],
        'bio': """We operate in the online advertising space and strive to
        offer the most user-friendly tools to allow advertisers, media
        agencies and marketers to advertise to their social media, email
        and blog followers.

        Our team is located in Vancouver and offer our products globally
        and are comprised of successful technology executives and
        entrepreneurs. For more questions, please contact us.""",
